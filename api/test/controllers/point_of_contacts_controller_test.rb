...
class PointOfContactsControllerTest < ActionController::TestCase
  ...
  test "should create point_of_contact" do
    assert_difference('PointOfContact.count') do
      post :create, point_of_contact: { companyName: @point_of_contact.companyName, email: @point_of_contact.email, name: @point_of_contact.name, password: @point_of_contact.password, phone: @point_of_contact.phone }
    end
  ...
  test "should update point_of_contact" do
    put :update, id: @point_of_contact, point_of_contact: { companyName: @point_of_contact.companyName, email: @point_of_contact.email, name: @point_of_contact.name, password: @point_of_contact.password, phone: @point_of_contact.phone }
    assert_response 204
  end
